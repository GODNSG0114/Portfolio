...
const [isSubmitted ,setisSubmitted] = useState(false);
  ...
  return (
    <div id='footer' className=" h-80% bg-[#1a5551]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-5 relative z-10">
        <div className="flex justify-between items-start">
          ...
          <div className="flex-1 lg:pt-12 pb-20 lg:pb-0 ">
            <h1 className="text-white text-5xl lg:text-7xl font-bold lg:pb-20 ">Contact</h1>
            ...
            <div className="flex gap-24">
              ...
              {/* SOCIAL Section */}
              <div>
                <h3 className="text-gray-400 text-sm font-semibold mt-10 lg:mt-0 w-full tracking-wider">SOCIAL :</h3>
                <div className="flex lg:gap-4 gap-10  mt-6"> 
