...
import Coding_profile from './DesignComponents/Coding_profile';
import DSA_Skill from './DesignComponents/DSA_Skill';
import Daily_question_card from './DesignComponents/Daily_question_card';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-8 lg:px-24 py-16">
        ...
        {/* Leetcode Profile */}
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-lime-400 mb-8">Coding Profiles</h2>
